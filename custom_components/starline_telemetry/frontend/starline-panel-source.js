...
class StarLineAppPanel extends HTMLElement {
  ...
  _styles() {
    return `
      ...
      *{box-sizing:border-box}button{font:inherit;-webkit-tap-highlight-color:transparent}.app{height:100%;min-height:0;display:grid;grid-template-rows:auto auto minmax(0,1fr) auto;overflow:hidden;overscroll-behavior:none}
      .app-header{z-index:10;min-height:64px;display:grid;grid-template-columns:52px minmax(0,1fr) 52px;align-items:center;padding:6px max(10px,env(safe-area-inset-right)) 5px max(10px,env(safe-area-inset-left));background:var(--surface);border-bottom:1px solid var(--border)}
      ...
      .title-button{justify-self:center;min-width:min(290px,100%);max-width:100%;min-height:44px;border:1px solid color-mix(in srgb,var(--accent,var(--primary-color,#03a9d9)) 24%,var(--border,var(--divider-color,#dfe3e8)));border-radius:16px;background:color-mix(in srgb,var(--accent,var(--primary-color,#03a9d9)) 5%,var(--surface,var(--card-background-color,#fff)));color:var(--primary-text-color);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:5px 14px;box-shadow:0 5px 16px rgba(23,45,76,.06);cursor:pointer}.title-button:focus-visible{outline:2px solid var(--accent,var(--primary-color,#03a9d9));outline-offset:2px}.title-button:active{transform:scale(.985);background:color-mix(in srgb,var(--accent,var(--primary-color,#03a9d9)) 13%,var(--surface,var(--card-background-color,#fff)));border-color:color-mix(in srgb,var(--accent,var(--primary-color,#03a9d9)) 42%,var(--border,var(--divider-color,#dfe3e8)));box-shadow:0 2px 7px rgba(23,45,76,.05)}.title-button strong{font-size:23px;line-height:1.05;font-weight:800}.title-button span{margin-top:3px;color:var(--muted);font-size:14px;line-height:1.2;font-weight:560;letter-spacing:.01em}
      ...
      .viewport{min-height:0;overflow-y:auto;overflow-x:hidden;overscroll-behavior:contain;touch-action:pan-y;background:var(--primary-background-color);scrollbar-width:none}.viewport::-webkit-scrollbar{display:none}.viewport.zoom-enlarged{overflow:hidden;touch-action:none}.canvas{width:100%;min-height:100%;transform-origin:0 0;will-change:transform}.view-stack{padding:9px max(10px,env(safe-area-inset-right)) 14px max(10px,env(safe-area-inset-left))}.view{display:none}.view.active{display:block}.vehicle-pane{display:none}.vehicle-pane.active{display:block}
      ...
      .summary-card{overflow:hidden;border:1px solid var(--border);border-radius:22px;background:var(--surface);box-shadow:0 4px 18px #00000010}.summary-hero{position:relative;height:calc(100dvh - 64px - 61px - 76px - 190px);min-height:535px;max-height:780px;overflow:hidden;background:#dcecf3}.summary-bg{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;filter:saturate(.96) contrast(.98)}.summary-bg.id-130{object-position:center 53%}.summary-bg.id-683{object-position:center 52%}.summary-overlay{position:absolute;inset:0;background:linear-gradient(90deg,#ffffffd8 0%,#ffffff73 31%,#ffffff0f 57%,transparent 76%)}
      ...
      .security-field{position:absolute;z-index:2;left:50%;bottom:160px;width:84%;height:230px;transform:translateX(-50%);border:3px solid color-mix(in srgb,var(--accent) 68%,transparent);border-bottom-color:transparent;border-radius:50% 50% 0 0/100% 100% 0 0;background:radial-gradient(ellipse at 50% 100%,color-mix(in srgb,var(--accent) 13%,transparent) 0 56%,transparent 72%);opacity:0;pointer-events:none}.security-field.armed,.security-field.alarm{opacity:1}.security-field.alarm{border-color:color-mix(in srgb,var(--danger) 76%,transparent);border-bottom-color:transparent;background:radial-gradient(ellipse at 50% 100%,color-mix(in srgb,var(--danger) 17%,transparent),transparent 72%)}
      .summary-car{position:absolute;z-index:3;left:50%;height:auto;transform:translateX(-50%);filter:drop-shadow(0 14px 11px #0000003b);pointer-events:none}.summary-car.id-130{bottom:146px;width:76%}.summary-car.id-683{bottom:162px;width:73%}.summary-car.open-state{transform:translate(-50%,6px)}.summary-card.offline .summary-bg,.summary-card.offline .summary-car{filter:grayscale(.55) saturate(.58)}
      ...
      .metrics{position:absolute;z-index:7;left:10px;right:10px;bottom:9px;display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:6px}.metric{min-width:0;min-height:67px;display:grid;grid-template-columns:24px minmax(0,1fr);align-items:center;gap:6px;padding:7px 7px;border:1px solid #ffffffef;border-radius:15px;background:#fffffff0;backdrop-filter:blur(8px);color:var(--primary-text-color);text-align:left}.metric strong{display:block;margin-top:4px;font-size:16px;line-height:1.05;font-weight:820;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
      .state-row{min-height:74px;display:grid;align-items:center;background:var(--surface)}.state-row+.state-row{border-top:1px solid var(--border)}.perimeter-row{grid-template-columns:repeat(3,minmax(0,1fr))}.operational-row{grid-template-columns:minmax(0,.95fr) minmax(0,1.55fr) minmax(0,.72fr)}.state,.event{min-width:0;min-height:52px;border:0;border-right:1px solid var(--border);background:transparent;color:var(--primary-text-color);display:grid;grid-template-columns:28px minmax(0,1fr);align-items:center;gap:7px;padding:7px 11px;text-align:left}.state:last-child,.event:last-child{border-right:0}.state ha-icon,.event ha-icon{color:var(--muted);--mdc-icon-size:24px}.state strong,.event strong{display:block;margin-top:4px;font-size:16px;line-height:1.05;font-weight:800;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.state.ok ha-icon,.state.ok strong{color:var(--ok)}.state.warn ha-icon,.state.warn strong{color:var(--warn)}.state.active ha-icon,.state.active strong,.event ha-icon{color:var(--accent)}.state.danger ha-icon,.state.danger strong{color:var(--danger)}
      ...
      @media(max-width:390px){.title-button{min-width:0;width:100%;padding-inline:8px}.title-button strong{font-size:21px}.title-button span{font-size:13px}.summary-hero{min-height:520px}.identity strong{font-size:27px}.identity span{font-size:15px}.summary-car.id-130{bottom:140px}.summary-car.id-683{bottom:157px}.security-field{bottom:154px;width:86%;height:220px}.metric{grid-template-columns:21px minmax(0,1fr);padding:6px 5px}.metric strong{font-size:14px}.state,.event{padding:6px 7px;grid-template-columns:25px minmax(0,1fr)}.state strong,.event strong{font-size:14px}.connection{max-width:52%}}
  ...
  _scene(vehicle) {
    ...
    return { id, state, src: `${ASSET_BASE}/starline-car-${id}-${suffix}.webp?v=${UI_VERSION}` };
  }
  ...
  _mountSummary(pane, vehicle) {
    ...
    pane.innerHTML = `<article class="summary-card">
      <div class="summary-hero">
        ...
        <img class="summary-car id-${scene.id}" src="${scene.src}" alt="Nissan Murano Z52">
  ...
  _patchSummary(pane, vehicle) {
    ...
    car.classList.toggle("open-state", ["hood-open", "trunk-open", "door-open"].includes(scene.state));
