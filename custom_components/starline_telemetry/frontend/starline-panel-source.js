  ...
  _styles() {
    return `
      ...
      *{box-sizing:border-box}button{font:inherit;-webkit-tap-highlight-color:transparent}.app{height:100%;min-height:0;display:grid;grid-template-rows:auto auto minmax(0,1fr) auto;overflow:hidden;overscroll-behavior:none}
      ...
      .title-button{min-width:0;border:0;background:transparent;color:var(--primary-text-color);display:flex;flex-direction:column;align-items:center;justify-content:center;padding:2px 8px}.title-button strong{font-size:23px;line-height:1.05;font-weight:850}.title-button span{margin-top:3px;color:var(--muted);font-size:14px;line-height:1;font-weight:750}
