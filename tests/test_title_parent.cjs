const SOURCE = 'custom_components/starline_telemetry/frontend/starline-panel-source.js';
const FRONTEND = 'custom_components/starline_telemetry/frontend';
const KIND = 'starline';
...
for (const testedSource of [SOURCE, 'custom_components/starline_telemetry/frontend/starline-app.js']) {
